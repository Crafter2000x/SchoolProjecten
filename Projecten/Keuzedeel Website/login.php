		   ...
		   <!-- to do write sheit-->
			<div class="container">
			  ...
			  <div class="card">
				...
				<form method="POST" action="login.php" id="formlogin">
				  ...
				  <div class="button-container">
					<button type="submit" name="login_user" form="formlogin"><span>Go</span></button>
				  </div>
			  ...
			  <div class="card alt">
				...
				<form method="POST" action="login.php" id="formreg">
				  <div class="input-container">
					<input type="text" name="username" value="<?php echo $username; ?>" required placeholder="Username"/>
					<div class="bar"></div>
				  </div>
				  <div class="input-container">
					<input type="email" name="email" value="<?php echo $email; ?>" required placeholder="Email adress"/>
					<div class="bar"></div>
				  </div>
				  <div class="input-container">
				  ...
				  <div class="input-container">
					<input type="password" name="password_2" required placeholder="Repeat Password"/>
					<div class="bar"></div>
				  </div>
				  
				  <div class="button-container">
					<button type="submit"  name="reg_user" form="formreg"><span>Next</span></button>
				  </div>
				</form>
			  </div>
			</div>
