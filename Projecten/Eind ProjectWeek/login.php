			...
			<div class="container">
			  ...
			  <div class="card">
				...
				<form>
				  ...
				  <div class="input-container">
					<input type="password" name="sPassword" required placeholder="Password"/>
					<div class="bar"></div>
				  </div>
				  <div class="button-container">
					<button><span><a href="index-login.php">Go</a></span></button>
				  </div>
			  ...
			  <div class="card alt">
				...
				<form id="formreg">
				  ...
				  <div class="input-container">
					<input type="email" name="sEmail" required placeholder="Email adress"/>
					<div class="bar"></div>
				  </div>
				  <div class="input-container">
					<input type="password" name="sPassword" required placeholder="Password"/>
				  ...
				  <div class="input-container">
					<input type="password" name="sRpassword" required placeholder="Repeat Password"/>
					<div class="bar"></div>
				  </div>
				  <div class="input-container">
					<input type="text" name="skey" required placeholder="School registration key"/>
					<div class="bar"></div>
				  </div>
				  
				  <div class="button-container">
					<button><span><a href="AccountSetup.php">Next</a></span></button>
				  </div>
				</form>
			  </div>
			</div>
