...
$oDBaction = new dbcommands_class();
    ...
    if(!empty($_POST)){
        ...
        $sEmail = cleanup('sEmail');
    
        $oDBaction->sPdoQuery = "INSERT INTO tbl_users(`studentnummer`,`voornaam`,`achternaam`,`email`,`workshopid`) VALUES ('".$iStudentnummer."','".$sFirstname."','".$sLastname."','".$sEmail."','".$workshopnr."')";
...
<br><br><div class="contactbox">
  ...
  <form method="POST">
    ...
    <a href="workshopsphp.php">Terug</a>
</div>